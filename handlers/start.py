...
GET_ACCESS_SCREEN_TEXT = (
    ...
    "• используем его уже более 4 лет\n"
    "• быстрый вывод средств (обычно до ~15 минут)\n"
    "• стабильная платформа и понятные условия\n\n"
    "⚙️ Наш алгоритм и сигнальная система настроены именно под эту площадку.\n\n"
    "У вас уже есть аккаунт на Intrade Bar?"
)
